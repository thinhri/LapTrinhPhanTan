...
public class FrmDangKy extends javax.swing.JFrame {
    ...
    private void butDangKyActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_butDangKyActionPerformed
        try {
            ...
            if (txtnhaplaimatkhau.getText().equals(matKhau) == false) {
                JOptionPane.showMessageDialog(this, "mat khau va nhap lai mat khau k0 dung");
                return;
            }
            TaiKhoan tk = new TaiKhoan();
            CoSo coso = new CoSo();
            coso.MoKetNoi();
            if (tk.TaoTaiKhoan(tenDn, matKhau, hoTen) == 1) {
                JOptionPane.showMessageDialog(this, "Da tao tai khoan");
            } else {
                JOptionPane.showMessageDialog(this, "Tai khoan nay da co");
            }
        } catch (Exception loi) {
