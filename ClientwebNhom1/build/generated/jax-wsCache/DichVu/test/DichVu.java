...
public interface DichVu {
     ...
     * 
     * @return
     *     returns java.util.List<test.Loaibean>
     */
    @WebMethod
    @WebResult(targetNamespace = "")
    @RequestWrapper(localName = "getLoai", targetNamespace = "http://Test/", className = "test.GetLoai")
    @ResponseWrapper(localName = "getLoaiResponse", targetNamespace = "http://Test/", className = "test.GetLoaiResponse")
    @Action(input = "http://Test/DichVu/getLoaiRequest", output = "http://Test/DichVu/getLoaiResponse")
